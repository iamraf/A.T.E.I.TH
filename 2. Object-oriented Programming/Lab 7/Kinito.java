class Kinito extends Tilefono
{
    ...
    Kinito(int secondsToKinita, int secondsToStathera, double costToKinita, double costToStathera)
    {
    ...
    Kinito(String phoneNumber, int secondsToKinita, int secondsToStathera, double costToKinita, double costToStathera)
    {
        super(phoneNumber);
    ...
    public void dial(String firstNumber, String secondNumber)
    {
        ...
        System.out.println("Klhsh apo to Kinito thlefono " + firstNumber + " pros to " + (temp == 6 ? "Kinito" : "Stathero") + " me arithmo " + secondNumber);
