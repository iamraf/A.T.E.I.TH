//http://aetos.it.teithe.gr/~adamidis/OOP/OOP_lab3_ta3inomhsh_1.pdf
...
class lab3
{
    public static void main(String[] args)
    {
        ...
        //Eisagogis
        MyUtils.insertSort(pinakas);
        MyUtils.insertSort_2(pinakas);

        //Epilogis
        MyUtils.selectSort(pinakas);

        //Fusalidas
        MyUtils.bubbleSort(pinakas);

        for(int i = 0; i < pinakas.length; i++)
        {
            System.out.println(pinakas[i].getEtos());
        }
    }
}
