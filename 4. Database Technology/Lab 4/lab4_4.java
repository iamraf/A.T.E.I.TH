...
public class lab4_4
{
    ...
    public static void main(String[] argv) throws Exception
    {
        ...
        statement.executeUpdate("insert into Sailors (sid, sname, rating, age) values (22, 'Dustin', 7, 45)");
        statement.executeUpdate("insert into Sailors (sid, sname, rating, age) values (29, 'Brutus', 1, 33)");
        statement.executeUpdate("insert into Sailors (sid, sname, rating, age) values (31, 'Lubber', 8, 55)");
        statement.executeUpdate("insert into Sailors (sid, sname, rating, age) values (32, 'Andy', 8, 25)");
        statement.executeUpdate("insert into Sailors (sid, sname, rating, age) values (58, 'Rusty', 10, 35)");
        statement.executeUpdate("insert into Sailors (sid, sname, rating, age) values (64, 'Horatio', 7, 35)");
        statement.executeUpdate("insert into Sailors (sid, sname, rating, age) values (71, 'Zorba', 10, 16)");
        statement.executeUpdate("insert into Sailors (sid, sname, rating, age) values (74, 'Horatio', 9, 40)");
        statement.executeUpdate("insert into Sailors (sid, sname, rating, age) values (85, 'Art', 3, 25)");
        statement.executeUpdate("insert into Sailors (sid, sname, rating, age) values (95, 'Bob', 3, 63)");
